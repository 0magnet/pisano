...
//
// It lives in its own package because two binaries want it: the plain terminal
// page, and the desktop one where a generated design can be opened in a second
// window. Neither is a special case of the other, so the command belongs to
// neither.
package app
